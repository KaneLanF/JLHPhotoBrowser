...
- (instancetype)initWithRootViewController:(UIViewController *)rootViewController
{
    ...
    if (self) {
        [self.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName: WordColorOne,NSFontAttributeName:[UIFont systemFontOfSize:18]}];
        [self.navigationBar setTintColor:WordColorOne];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        [ZLPhotoManager getPhotoAblumList:nav.allowSelectVideo allowSelectImage:nav.allowSelectImage complete:^(NSArray<ZLAlbumListModel *> *albums) {
            ...
            weakSelf.arrayDataSources = [NSMutableArray arrayWithArray:albums];
