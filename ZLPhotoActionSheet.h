...
@property (nonatomic, assign) BOOL allowsEditing;//拍照片后选择使用照片后，是否允许跳转到编辑图片，默认NO;(self.maxSelectCount == 1 && self.editAfterSelectThumbnailImage= YES  才有效)
...
-(void)customSlectedPhoto;//聊天消息界面选择照片发送照片入口
